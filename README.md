...
Server & Security Info is a powerful yet lightweight WordPress plugin that gives you complete visibility into your server's health and security status. No complex setup required - just activate and go.

Why Choose This Plugin

Unlike other heavy monitoring plugins that slow down your site, this plugin is built with performance first. It adds minimal load to your WordPress admin and provides all essential information in one place.

Key Features

Server Information

*   PHP Version - Current PHP version running on your server
*   MySQL Version - Database server version
*   WordPress Version - Current WP version
*   Server Software - Apache/Nginx/IIS information
*   CPU Load Average - Real-time server load

Plugins Management
*   Total plugins installed count
*   Active plugins count
*   Available updates count with warning indicator

Themes Information
*   Active theme name and version
*   Total themes installed count

PHP Configuration
*   max\_execution\_time - Script execution time limit
*   memory\_limit - PHP memory limit
*   upload\_max\_filesize - Maximum file upload size
*   post\_max\_size - Maximum POST data size
    
Storage and Database
*   Total disk space usage
*   Used and free space with progress bar
*   Database size
...
*   WP\_DEBUG mode status
*   File editor access status
...
*   Real-time user enumeration vulnerability check
*   Shows exposed usernames if found
*   One-click fix to block author enumeration
    
Directory Indexing Protection
*   Uploads directory status
*   Plugins directory status
*   Themes directory status
*   One-click fix to disable directory listing
    
Real-time Live Monitor
*   Check site status instantly
...
*   Clean unused data (revisions, spam, transients)
...
Performance Stats
*   Total plugin size is approximately 25KB only
*   Database queries are 5 to 7 per page load
*   Memory usage is about 1.5MB only
...
<img width="1896" height="1454" alt="Image" src="https://github.com/user-attachments/assets/0fa771c1-7397-47f6-991c-ec1d2288b989" />
